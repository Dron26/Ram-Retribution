    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 resolveMainColor(v2f i)
            {
                ...
                _FillLevel = _FillLevel * _MainTex_ST.x; // Modified for horizontal fill
                float filledColor = smoothstep(_FillLevel, _FillLevel + _FadeAreaHeight, i.uv.x - _MainTex_ST.z); // Modified for horizontal fill
            ...
            fixed4 hotLineColor(v2f i)
            {
                ...
                result = lerp(0, result, 1 - smoothstep(0, _HotLineHeight, abs(_FillLevel + _HotLineHeight - i.uv.x + _MainTex_ST.z))); // Modified for horizontal fill
